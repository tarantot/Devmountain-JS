...
var first = new Employee(empOne.name, empOne.shifts)
...
var second = new Manager(manager.name, manager.shifts, manager.employees);
...
//CODE HERE
second.getEmployees();
//Winston manages Cece,Schmidt,Coach.